...
object CommandProcessor {
    ...
    fun process(context: Context, text: String): String? {
        ...
        // 값/하위옵션/시간보정 중 하나라도 지정됐을 때만 상세 화면에 들어가 값을 수정함.
        // 아이콘 탭은 항상 기본값으로 자동 기록만 하고(상세화면 자동으로 안 뜸),
        // 값을 바꾸려면 방금 생긴 리스트 최상단 항목을 다시 열어야 한다.
        ...
        // 항상 마지막에 저장 시도: 목욕처럼 바로 입력 화면이 뜨는 카테고리 대응.
